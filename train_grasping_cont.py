...
if __name__ == "__main__":
    ...
    best_model_path = f"./models_sac_grasp_best/{exp}/best_model.zip"
    ...
    #(Optional) If you want a smaller LR for fine-tuning, uncomment:
    #new_lr = 1e-4
    ...
    checkpoint_callback = CheckpointCallback(
        ...
        save_path=f"./models_phase2/{exp}/",
        name_prefix="sac_grasp_phase2",
    )

    eval_callback = EvalCallback(
        eval_env,
        best_model_save_path=f"./models_sac_grasp_best_phase2/{exp}/",
        log_path=f"./logs/{exp}/logs_sac_grasp_eval_phase2/",
    ...
    outcome_callback = EpisodeOutcomeCallback(
        ...
        csv_path=f"./debug/{exp}/episode_outcomes_400k.csv",
        verbose=1,
    )
    ...
    model.save(f"./models/{exp}/sac_grasp_phase2_final_400K.zip")
